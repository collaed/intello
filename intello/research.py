...
BASELINE_PROVIDERS: list[LLMProvider] = [
    ...
    LLMProvider("Llama 3.1 405B (OR)", "meta-llama/llama-3.1-405b-instruct:free", "openrouter", Tier.FREE, 128_000,
    ...
    LLMProvider("Qwen3 235B (OR)", "qwen/qwen3-235b-a22b:free", "openrouter", Tier.FREE, 40_960,
                [TaskType.CODE, TaskType.MATH, TaskType.ANALYSIS],
                0.0, 0.0, "OPENROUTER_API_KEY",
                notes="Free via OpenRouter, strong at code/math", daily_limit=200),
